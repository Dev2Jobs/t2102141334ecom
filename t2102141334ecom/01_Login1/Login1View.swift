...
class Login1View: UIViewController {
	...
	@IBOutlet var labelTitle: UILabel! = UILabel()
	@IBOutlet var labelSubTitle: UILabel! = UILabel()
	@IBOutlet var imageViewLogo: UIImageView!
	@IBOutlet var textFieldEmail: UITextField! = UITextField()
	@IBOutlet var textFieldPassword: UITextField! = UITextField()
